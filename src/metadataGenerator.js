...
const categories = {
  sleeping: {
    titles: [
      "Deep Sleep Music 😴 Calm Your Mind | Relaxing Sounds for Restful Sleep",
      "Sleep Fast & Easy 🌙 Gentle Music to Drift Off | 1 Hour Sleep Aid",
      "Peaceful Night Music 🌟 Soothing Melodies for Deep Sleep",
      "Fall Asleep in Minutes 💤 Soft Sleep Music | Stress Relief",
  ...
  meditation: {
    titles: [
      "5-Minute Meditation Music 🧘 Clear Your Mind | Daily Mindfulness",
      "Deep Meditation Music 🕉️ Zen Sound Journey | Inner Peace & Calm",
      "Morning Meditation 🌅 Start Your Day Right | Peaceful Background Music",
  ...
  relaxing: {
    titles: [
      "Relaxing Music for Stress Relief 🌿 Calm Background | Work & Study",
      "Peaceful Piano Music 🎹 Relax Your Mind | 1 Hour Ambient Sounds",
      "Nature & Music Blend 🌊 Ocean Waves & Soft Piano | Ultimate Relaxation",
    ...
    descriptions: [
      `🌿 Unwind and de-stress with this beautiful relaxing music. Whether you're working, studying, or just need to relax, this music creates the perfect peaceful atmosphere.\n\n✨ Ideal For:\n• Work from home background music\n• Study sessions\n• Evening wind-down\n• Spa and self-care\n• Reading and journaling\n\n🎵 Music Style:\n• Soft ambient melodies\n• Calming harmonies\n• Gentle rhythms\n• Peaceful soundscapes\n\n#RelaxingMusic #StressRelief #CalmMusic`,
      `🌊 Let this serene music wash away your stress and worries. Perfect background music for any relaxing activity.\n\n🌸 Why People Love This:\n• Instantly calming\n• Non-intrusive background sound\n• Helps with focus and creativity\n• Reduces workplace stress\n\n💆 Perfect For:\n• Remote work\n• Studying for exams\n• Creative projects\n• Evening relaxation\n\n#AmbientMusic #RelaxationMusic #ChillMusic`,
    ],
    tags: [
